...
<h4 class="text-center" style="color:red">${error}</h4>
	<div id="container">
		<div class= "w-50 border border-1 m-auto h-200">
			...
			<form action="/web02/main/searchid.do" class="mt-2 form-control">
				<input type = "text" name = "user_name" class="mt-2 form-control" placeholder="이름을 입력하세요"><br>
				<input type = "text" name ="user_age"class="mt-2 form-control" placeholder="나이를 입력하세요">
				<button class="mt-3 btn btn-primary">아이디 찾기</button>
			</form>
			
			<c:if test="${not empty find_id}">
				<p class="mt-4 mb-0" style="color :gray">회원님의 아이디 입니다.</p>
				<input value ="${find_id}" class="form-control mb-2" readonly>
